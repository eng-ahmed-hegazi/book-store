...
@section('content')
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="{{route('user.profile.update')}}" method="post" class="form" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{$user->profile->facebook}}" name="facebook" placeholder="Enter Facebook Link" class="form-control">
                </div>
                <div class="form-group">
                    <label for="youtube">Youtube</label>
                    <input type="text" value="{{$user->profile->youtube}}" name="youtube" placeholder="Enter Youtube Link" class="form-control">
                </div>
                <div class="form-group">
